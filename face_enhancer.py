...
supported_enhancers = {
    "CodeFormer": ("./pretrained_model/codeformer.onnx", codeformer_runner),
    "GFPGAN": ("./pretrained_model/GFPGANv1.4.pth", gfpgan_runner),
    "REAL-ESRGAN 2x": ("./pretrained_model/RealESRGAN_x2.pth", realesrgan_runner),
    "REAL-ESRGAN 4x": ("./pretrained_model/RealESRGAN_x4.pth", realesrgan_runner),
    "REAL-ESRGAN 8x": ("./pretrained_model/RealESRGAN_x8.pth", realesrgan_runner)
}
